...
const PRODUCTS: Product[] = [
  ...
  {
    id: "prod-6",
    name: "Eco-Friendly Padded Laptop Sleeve",
    price: 1199,
    category: "Bags & Totes",
    rating: 4.7,
    reviews: 118,
    image: "💻",
    description: "Sleek and natural laptop sleeve crafted out of blended jute-cotton fabric. Features organic wool-felt shock protective padding, inner pocket, and a beautiful coconut-shell button locking loop.",
    origin: "Karnataka, India",
    material: "Jute-Cotton Canvas, Wooden Buttons",
    dimensions: "Fits up to 15.6-inch laptops"
  }
];
